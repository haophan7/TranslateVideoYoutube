...
CARD_DIMENSIONS = QSize(90, 140)
CARD_RECT = QRect(0, 0, 90, 140)
CARD_SPACING_X = 150
...
class MainWindow(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        menu = self.menuBar().addMenu("&Game Setting")

        deal_action = QAction(QIcon(os.path.join('images', 'playing-card.png')), "Restart game", self)
        ...
        self.setWindowTitle("Hardest Snake Solitaire")
        self.show()

    def restart_game(self):
        reply = QMessageBox.question(self, "Restart", "Are you sure you want to start a new game?",
